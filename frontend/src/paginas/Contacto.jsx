    ...
    <section className="min-h-screen bg-slate-50 pb-20 pt-28">
        ...
        <div className="grid gap-10 lg:grid-cols-2">
            ...
            <h2 className="text-2xl font-semibold leading-tight sm:text-3xl">
                Diseñamos páginas web modernas, rápidas y administrables.
            </h2>
            ...
            <form id="form-contacto" tabIndex="-1" onSubmit={handleSubmit} className="mt-8 space-y-6">
                ...
                <input
                    ...
                    className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-400 focus:ring-4 focus:ring-slate-200"
                />
                </div>
                ...
                <textarea
                    name="mensaje"
                    placeholder="Cuéntanos tu idea, negocio o lo que necesitas desarrollar..."
                    value={form.mensaje}
                    onChange={handleChange}
                    rows={6}
                    className="w-full rounded-2xl border border-slate-200 px-4 py-3 text-slate-900 outline-none transition focus:border-slate-400 focus:ring-4 focus:ring-slate-200"
